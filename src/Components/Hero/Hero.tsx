...
import { cardItems } from "../../constant"; // Import your product data

const HeroSection: React.FC = () => {
  const [isLoading, setIsLoading] = useState(true);

  // Simulate loading effect, you can replace this with your actual loading logic
  useEffect(() => {
  ...
  return (
    <div className="p-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
      {isLoading
        ? Array(4)
            .fill(0)
            .map((_, index) => (
